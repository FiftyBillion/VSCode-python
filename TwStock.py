...
print("Please Enter the Stock Number: ")
stknum = input()

# 先與網站請求抓到價格
def getstock(stocknumber=stknum):
    url = (
        "http://www.twse.com.tw/exchangeReport/STOCK_DAY?response=json&date=20190731&stockNo="
        + stocknumber
        + "&_="
...
# 開始計算股票的平均以及標準差
def Standard_Deviation(stocknumber=stknum):
...
Standard_Deviation(stocknumber=stknum)
